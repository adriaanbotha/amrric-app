  ...
  try {
    ...
    final houses = [
      // Houses in Darwin CBD (location_nt_001) for census user
      {
        ...
        'latitude': -12.4634,
        'longitude': 130.8456,
        'description': 'Two dogs, friendly owners',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
      {
        ...
        'latitude': -12.4612,
        'longitude': 130.8423,
        'description': 'One cat, indoor only',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
      {
        ...
        'councilId': 'council_nt_001',
        'houseNumber': '78',
        'streetName': 'Knuckey Street',
        'suburb': 'Darwin',
        'postcode': '0800',
        'latitude': -12.4598,
        'longitude': 130.8401,
        'description': 'Two cats and one dog',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
      ...
      },
      {
        ...
        'councilId': 'council_nt_001',
        'houseNumber': '34',
        'streetName': 'Bennett Street',
        'suburb': 'Darwin',
        'postcode': '0800',
        'latitude': -12.4623,
        'longitude': 130.8467,
        'description': 'No pets currently',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Alice Springs CBD (location_nt_002)
      {
        'id': 'house_alice_001',
        'locationId': 'location_nt_002',
        'councilId': 'council_nt_002',
        'houseNumber': '56',
        'streetName': 'Todd Street',
        'suburb': 'Alice Springs',
        'postcode': '0870',
        'latitude': -23.6980,
        'longitude': 133.8807,
        'description': 'Family with multiple pets',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
      {
        ...
        'councilId': 'council_nt_002',
        'houseNumber': '23',
        'streetName': 'Gregory Terrace',
        'suburb': 'Alice Springs',
        'postcode': '0870',
        'latitude': -23.7001,
        'longitude': 133.8823,
        'description': 'Single dog owner',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Katherine CBD (location_nt_003)
      {
        'id': 'house_katherine_001',
        'locationId': 'location_nt_003',
        'councilId': 'council_nt_003',
        'houseNumber': '89',
        'streetName': 'Katherine Terrace',
        'suburb': 'Katherine',
        'postcode': '0850',
        'latitude': -14.4650,
        'longitude': 132.2630,
        'description': 'Cat and dog household',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Brisbane CBD (location_qld_001)
      {
        'id': 'house_brisbane_001',
        'locationId': 'location_qld_001',
        'councilId': 'council_qld_001',
        'houseNumber': '123',
        ...
        'latitude': -27.4698,
        'longitude': 153.0251,
        'description': 'Apartment with small dog',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
      {
        'id': 'house_brisbane_002',
        'locationId': 'location_qld_001',
        'councilId': 'council_qld_001',
        'houseNumber': '456',
        ...
        'latitude': -27.4710,
        'longitude': 153.0260,
        'description': 'Family home with multiple pets',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Sydney CBD (location_nsw_001)
      {
        'id': 'house_sydney_001',
        'locationId': 'location_nsw_001',
        'councilId': 'council_nsw_001',
        'houseNumber': '789',
      ...
      // Houses in Melbourne CBD (location_vic_001)
      {
        'id': 'house_melbourne_001',
        'locationId': 'location_vic_001',
        'councilId': 'council_vic_001',
        'houseNumber': '321',
        ...
        'latitude': -37.8136,
        'longitude': 144.9631,
        'description': 'Cat owner, indoor only',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Adelaide CBD (location_sa_001)
      {
        'id': 'house_adelaide_001',
        'locationId': 'location_sa_001',
        'councilId': 'council_sa_001',
        'houseNumber': '654',
        ...
        'latitude': -34.9285,
        'longitude': 138.6007,
        'description': 'Dog walking business owner',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Perth CBD (location_wa_001)
      {
        'id': 'house_perth_001',
        'locationId': 'location_wa_001',
        'councilId': 'council_wa_001',
        'houseNumber': '987',
        'streetName': 'Hay Street',
        'suburb': 'Perth',
        'postcode': '6000',
        'latitude': -31.9505,
        'longitude': 115.8605,
        'description': 'Veterinary clinic owner',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Hobart CBD (location_tas_001)
      {
        'id': 'house_hobart_001',
        'locationId': 'location_tas_001',
        'councilId': 'council_tas_001',
        'houseNumber': '147',
        ...
        'latitude': -42.8821,
        'longitude': 147.3272,
        'description': 'Pet rescue volunteer',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },

      // Houses in Canberra CBD (location_act_001)
      {
        'id': 'house_canberra_001',
        'locationId': 'location_act_001',
        'councilId': 'council_act_001',
        'houseNumber': '258',
        ...
        'latitude': -35.2809,
        'longitude': 149.1300,
        'description': 'Government employee with pets',
        'isActive': true,
        'createdAt': DateTime.now().toIso8601String(),
        'updatedAt': DateTime.now().toIso8601String(),
      },
    ...
    for (final house in houses) {
      try {
        ...
        debugPrint('House ${house['streetName']} created successfully');
      } catch (e) {
        debugPrint('Error creating house ${house['streetName']}: $e');
        rethrow;
      }
    }
